    ...
    <div className="transition-all duration-500 p-12 overflow-hidden mx-auto min-h-screen bg-black w-full md:p-36">
      <div className="bg-white text-black rounded-xl overflow-hidden text-white px-6 pb-12 md:px-12 shadow-xl md:w-[550px] mx-auto py-4">
        <form onSubmit={handleSubmit}>
          <p className="font-extrabold text-4xl text-black text-center my-4 md:my-8 text-xl">
            PRYPTO
          </p>
          ...
          <br />
          <input
            className="focus:outline focus:border-black border outline-transparent outline-offset-2 rounded-md md:w-30 py-3 w-full mt-2 text-black pl-4"
            type="text"
            required
          ...
          <button
            type="submit"
            className="hover:bg-black hover:text-white mt-8 text-black py-3 rounded-md w-full bg-white border text-xl"
          >
            Signup
          </button>
      ...
      <p className="text-white text-center mt-5 font-base">
        ...
        <span
          className="text-[#EDABC2] hover:text-[#fc90b6] font-bold cursor-pointer ml-1 hover:underline"
          onClick={() => {
